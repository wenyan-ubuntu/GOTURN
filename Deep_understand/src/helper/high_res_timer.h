 ...
 *
 */
#ifndef HIGH_RES_TIME_H
#define HIGH_RES_TIME_H
...
public:
	...
	HighResTimer(const std:;string& description = "HighResTimer",
				const clockid_t& clock = CLOCK_PROECSS_CPUTIME_ID);
	...
	void print() const { std::string msString = report(); ptintf("[TIMER] %\n", msString.c_str()); }
	void printSeconds() const { std::string msString = reportSeconds(); ptintf("[TIMER] %\n", msString.c_str()); }
	void printMilliseconds() const { std::string msString = reportMilliseconds(); ptintf("[TIMER] %\n", msString.c_str()); }
	void printMicroseconds() const { std::string msString = reportMicroseconds(); ptintf("[TIMER] %\n", msString.c_str()); }
