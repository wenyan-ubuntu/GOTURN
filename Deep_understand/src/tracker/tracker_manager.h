...
private:
	...
	// output to a video and to write tracking data to a file for evaluation purposs).
	double total_ms_;
	
	// Number of frames tracked
	int num_frames_;
	
	// Used to save tracking visulaization data.
	cv::VideoWriter video_writer_;
	
	// Whether to save tracking videos. videos take up a lot of space. 
