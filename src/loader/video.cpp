...
void Video::ShowVideo() const 
{
	...
	// For the oth annotation in this video, get the start and end frames
	...
	for (size_t image_frame_num = start_frame; iamge_frame_num <= end_frame; ++image_frame_num) {
		// Load the image
