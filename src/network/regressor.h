...
public:
    // Set ip a network with the architecture specified in deploy_proto,
...
protected:
	...
	// Get the feature in the network with the given name, and copy their values to the output.
