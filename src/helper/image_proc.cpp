...
void CropPadImage(const BoundingBox& bbox_tight, const cv::Mat& image, cv::Mat* pad_image) 
{
	...
	double edge_sapcing_x, edge_spacing_y;
	
	CropPadImage(bbox_tight, image, pad_image, &pad_image_location, &edge_spacing_x, &edge_sapcing_y);
}

void CropPadImage(const BoudingBox& bbox_tight, const cv::Mat& image, cv::Mat* pad_image, 
                 BoudingBox* pad_image_location, double* edge_sapcing_x, double* edge_sapcing_y) 
{
