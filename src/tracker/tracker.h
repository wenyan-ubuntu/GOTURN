...
public:
	...
	// Estimate the location of the target object in the curretn imagesize
	virtual void Track(const cv::Mat& image_curr, RegressionBase* regressor,
	                   BoundingBox* bbox_estimate_uncentered);
					   
	// Initialize the location of the target object in the current image_curr
